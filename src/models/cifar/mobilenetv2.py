...
* Majority of this code is borrowed from https://github.com/weiaicunzai/pytorch-cifar100/blob/master/models/mobilenet.py
"""
...
class MobileNetV2(nn.Module):
    ...
    def dump_layers(self) -> Tuple[List[nn.Module], List[nn.Module]]:
        ...
        """
        return ([self.pre,
                 self.stage1, self.stage2, self.stage3, self.stage4, self.stage5, self.stage6, self.stage7,
                 self.conv1, self.adaptive_avg_pool2d],
                [self.conv2])
